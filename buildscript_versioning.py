...
env.Replace(PROGNAME="burnerpower_controller_firmware_%s_%s" %
            (env["PIOPLATFORM"], env["PIOENV"]))

env.Replace(ESP8266_FS_IMAGE_NAME="burnerpower_filesystemimage_%s_%s" %
            (env["PIOPLATFORM"], env["PIOENV"]))

env.Replace(ESP32_SPIFFS_IMAGE_NAME="burnerpower_controller_filesystemimage_%s_%s" %
            (env["PIOPLATFORM"], env["PIOENV"]))
