...
public:
    ...
    static void begin();
    static void Reset();
    static uint16_t ReadManufacturerID();
    static uint16_t ReadDeviceID();
    static void SetCalibration(uint16_t Calibration);
    static uint16_t GetCalibration(uint16_t Address);
    static int32_t GetCurrent();
    static uint32_t GetVBus();
    static int32_t GetVShunt(uint8_t ADCRange);
    static void setShunt(float shuntRes);
    static void setShuntCal(float shuntCal);
...
#pragma pack(pop)
    static ADCRANGE adcRange_;
    static bool present;
    static float currentLsb;
    static float shuntRes_;
};
